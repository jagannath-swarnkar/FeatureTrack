...
import { addNewModule, deleteModule, getAllModules, getModuleDetails, updateOneModule } from "../controllers/modules";
// import { getProfile } from "../controllers/profile";
import { AuthGuard } from "../utils/AuthGuard";
import { BasicAuth } from "../utils/BasicAuth";
import { addNewPage, deletePage, getAllPages, getPageDetails, updateOnePage } from "../controllers/pages";
import { getAllComponents, addNewComponent, deleteComponent, updateOneComponent, getComponentDetails } from "../controllers/components";
...
router.get("/modules/:id", [AuthGuard], getModuleDetails);
...
router.get("/pages/:id", [AuthGuard], getPageDetails);
...
router.get("/components/:id", [AuthGuard], getComponentDetails);
